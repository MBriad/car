...
#define BUZZER_on			BUZZER = 0		//开启蜂鸣器
#define BUZZER_off			BUZZER = 1		//关闭蜂鸣器
#define Headlight_on		Headlight = 0	//开启前大灯
#define Headlight_off		Headlight = 1	//关闭前大灯
#define on	1  //开，宏定义
#define off 0  //关，宏定义
...
sbit LightSensorLeft	=	P0^1;//左寻光传感器
sbit LightSensorRight	=	P0^2;//右寻光传感器
sbit AHA_Sensor			=	P0^3;//自动大灯传感器Automatic Headlight Activation
sbit MIC				=	P0^4;//拍手传感器
sbit HI_Sensor			=	P3^7;//人体红外传感器

/*前大灯接口定义*/
sbit Headlight 	= 	P0^5;//前大灯
