...
- Branch naming: `feat/<short-desc>` for features, `fix/<short-desc>` for fixes.
- Squash-merge into main when the branch is verified runnable.
- Delete the feature branch after merge.
- Run tests before pushing any branch.
...
Rules:
- **MAJOR (X):** Breaking changes or first stable release.
